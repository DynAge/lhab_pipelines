...
if __name__ == "__main__":
    ...
    shouldbe_there = [
        ...
        oj(output_dir, "sub-lhabX9999/ses-tp3/fmap/sub-lhabX9999_ses-tp3_acq-bold_dir-PA_run-1_epi.nii.gz"),
        ...
        oj(output_dir, "sub-lhabX9999/ses-tp3/fmap/sub-lhabX9999_ses-tp3_acq-dwi_dir-AP_run-1_epi.nii.gz"),
        oj(output_dir, "sub-lhabX9999/ses-tp3/fmap/sub-lhabX9999_ses-tp3_acq-dwi_dir-PA_run-1_epi.nii.gz"),
